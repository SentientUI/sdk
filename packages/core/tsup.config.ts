...
export default defineConfig({
  ...
  entry: ['src/index.ts', 'src/index-graph.ts', 'src/index-engagement.ts', 'src/index-topics.ts', 'src/index-server.ts', 'src/index-local.ts', 'src/index-local-stub.ts', 'src/index-region.ts', 'src/index-style-sample.ts', 'src/index-consent.ts'],
  format: ['esm', 'cjs'],
  outExtension({ format }) {
